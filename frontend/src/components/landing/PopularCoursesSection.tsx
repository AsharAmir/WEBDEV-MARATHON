...
const PopularCoursesSection: React.FC = () => {
  // Use the first 3 courses from mock data
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-12">
          <div>
            ...
            <p className="text-xl text-gray-600 max-w-2xl">
              Discover our highest rated and most enrolled courses from top tutors around the world.
            </p>
          </div>
          <Link 
            to="/courses" 
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex items-center space-x-1">
            ...
            <span className="text-gray-700">{course.totalStudents.toLocaleString()}</span>
          </div>
        </div>
